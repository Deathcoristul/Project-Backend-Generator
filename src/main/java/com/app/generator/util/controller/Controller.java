                ...
                for (Service service : services) {
                    ...
                    for(Repository repository: service.getRepositories())
                    {
                        ...
                        if(dom.isRelation())
                        {
                            ...
                            picoWriter.writeln("@GetMapping(\""+serviceName+"/"+repositoryName+"/{id}/{id2}\")");
                            picoWriter.writeln_r("fun get"+domainNameCap+"ById(@PathVariable(\"id\") id:"+ idField.getValue()+",@PathVariable(\"id2\") id2:"+second.getValue()+"):ResponseEntity<"+domainNameCap+">{");
                            picoWriter.writeln("val "+domainNameCap.toLowerCase()+":"+domainNameCap+"?="+serviceName+".get"+domainNameCap+"ById(id,id2)");
                            ...
                            picoWriter.writeln("@PutMapping(\""+serviceName+"/"+repositoryName+"/{idOld}/{idOld2}\")");
                            picoWriter.writeln_r("fun update"+domainNameCap+"(@PathVariable(\"idOld\") idOld:"+idField.getValue()+",@PathVariable(\"idOld2\") idOld2:"+second.getValue()+",@RequestBody "+ dom.getName().toLowerCase()+":"+domainNameCap +"): ResponseEntity<Unit>{");
                            picoWriter.writeln("val old"+dom.getName().toLowerCase()+":"+domainNameCap+"? = "+serviceName+".get"+domainNameCap+"ById(idOld,idOld2)");
                            ...
                            picoWriter.writeln_lr("else");
                            picoWriter.writeln(serviceName+".update"+domainNameCap+"(idOld,idOld2,"+dom.getName().toLowerCase()+")");
                            picoWriter.writeln("return ResponseEntity(null, HttpStatus.ACCEPTED)");
                            picoWriter.writeln_l("");
                            picoWriter.writeln_l("}");

                            picoWriter.writeln("@DeleteMapping(\""+serviceName+"/"+repositoryName+"/{"+ idField.getKey()+"}/{"+second.getKey()+"}\")");
                            picoWriter.writeln_r("fun delete"+domainNameCap+"(@PathVariable(\""+ idField.getKey()+"\") "+ idField.getKey() +":"+ idField.getValue() +",@PathVariable(\""+ second.getKey()+"\") "+ second.getKey() +":"+ second.getValue() +"): ResponseEntity<Unit>{");
                            picoWriter.writeln("val "+dom.getName().toLowerCase()+":"+domainNameCap+"? = "+serviceName+".get"+domainNameCap+"ById("+ idField.getKey() +","+second.getKey()+")");
                            picoWriter.writeln_r("if("+domainNameCap.toLowerCase()+"==null)");
                            picoWriter.writeln("return ResponseEntity(null, HttpStatus.NO_CONTENT)");
                            picoWriter.writeln_lr("else");
                            picoWriter.writeln(serviceName+".delete"+domainNameCap+"("+idField.getKey()+","+second.getKey()+")");
                            picoWriter.writeln_l("");
                ...
                for (Service service : services) {
                    ...
                    for(Repository repository: service.getRepositories())
                    {
                        ...
                        if(dom.isRelation())
                        {
                            Pair<String,String> second=dom.getFields().get(1);
                            picoWriter.writeln("@GetMapping(\""+serviceName+"/"+repositoryName+"/{id}/{id2}\")");
                            picoWriter.writeln_r("ResponseEntity<"+domainNameCap+"> get"+domainNameCap+"ById(@PathVariable(\"id\") "+ idField.getValue()+" id,@PathVariable(\"id2\") "+second.getValue()+" id2){");
                            picoWriter.writeln(domainNameCap+" "+domainNameCap.toLowerCase()+"="+serviceName+".get"+domainNameCap+"ById(id,id2);");
                            picoWriter.writeln_r("if("+domainNameCap.toLowerCase()+"==null)");
                            ...
                            picoWriter.writeln("@PutMapping(\""+serviceName+"/"+repositoryName+"/{idOld}/{idOld2}\")");
                            picoWriter.writeln_r("ResponseEntity update"+domainNameCap+"(@PathVariable(\"idOld\") "+ idField.getValue() +" idOld,@PathVariable(\"idOld2\") "+second.getValue()+" idOld2,@RequestBody "+ domainNameCap+" "+dom.getName().toLowerCase()+"){");
                            picoWriter.writeln(domainNameCap+" old"+dom.getName().toLowerCase()+" = "+serviceName+".get"+domainNameCap+"ById(idOld,idOld2);");
                            picoWriter.writeln_r("if(old"+domainNameCap.toLowerCase()+"==null)");
                            ...
                            picoWriter.writeln("@DeleteMapping(\""+serviceName+"/"+repositoryName+"/{"+ idField.getKey()+"}/{"+second.getKey()+"}\")");
                            picoWriter.writeln_r("ResponseEntity delete"+domainNameCap+"(@PathVariable(\""+ idField.getKey()+"\") "+ idField.getValue() +" "+ idField.getKey() +",@PathVariable(\""+ second.getKey()+"\") "+ second.getValue() +" "+ second.getKey()+"){");
                            picoWriter.writeln(domainNameCap+" "+dom.getName().toLowerCase()+" = "+serviceName+".get"+domainNameCap+"ById("+ idField.getKey() +","+second.getKey()+");");
                            picoWriter.writeln_r("if("+domainNameCap.toLowerCase()+"==null)");
                            picoWriter.writeln("return new ResponseEntity<>(null, HttpStatus.NO_CONTENT);");
                            picoWriter.writeln_lr("else");
                            picoWriter.writeln(serviceName+".delete"+domainNameCap+"("+idField.getKey()+","+second.getKey()+");");
